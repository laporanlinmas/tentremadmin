          ...
          <div>
            ...
            {urlMode === 'upload' ? (
              <>
                {form.foto ? (
                  /* Preview foto */
                  <FileDropzone onFile={handleFileSelect} inputRef={fileInputRef} accept="image/jpeg,image/png,image/webp"
                    style={{ position: 'relative', borderRadius: 10, overflow: 'hidden', border: '1px solid var(--border)', maxHeight: 160 }}>
