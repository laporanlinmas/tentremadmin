import { Key, Save, UserPlus, Plus, Shield, ChevronDown, Eye, EyeOff, UserCheck, Trash2, CheckCircle, Tag } from 'lucide-react';
...
export const Pengaturan: React.FC = () => {
  ...
  const handleAddKategori = async () => {
    ...
    if (kategoriAduanList.includes(val)) {
      triggerToast('Kategori sudah ada dalam daftar.', 'inf');
      return;
    }
