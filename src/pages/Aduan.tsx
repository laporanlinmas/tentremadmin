        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            <div className="fgrp">
              ...
              <FileDropzone onFile={handleFileChange} accept="image/*" className="file-dropzone" style={{ display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap' }}>
                <button
                  type="button"
                  onClick={(event) => { event.stopPropagation(); (event.currentTarget.parentElement?.querySelector('input[type="file"]') as HTMLInputElement | null)?.click(); }}
                  className="bg2"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '6px 12px', fontSize: '.72rem' }}
                >
                ...
                <span style={{ width: '100%', fontSize: '.68rem', color: 'var(--muted)' }}>atau seret foto ke area ini</span>
              </FileDropzone>
